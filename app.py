...
MOD_UPLOADS_FOLDER = 'mod_uploads'
...
cluster_topics = joblib.load("model/cluster_topics.pkl")
...
def update_cluster_topics(new_labels):
    ...
    joblib.dump(new_topic_mapping, "model/cluster_topics.pkl")
...
def submit_document():
    ...
    try:
        ...
        if file and allowed_file(file.filename):
            ...
            mod_uploads_path = os.path.join('mod_uploads', filename)
    ...
    try:
        ...
        if request.method == "POST":
            ...
            try:
                ...
                joblib.dump(cluster_topics, "model/cluster_topics.pkl")
